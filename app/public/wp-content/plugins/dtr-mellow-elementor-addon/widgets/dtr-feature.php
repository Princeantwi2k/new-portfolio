 ...
 * Widget
 */
class Mellow_Feature extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'dtr-feature--boxed'	=> esc_html__( 'Boxed', 'mellow' ),
				],
			]
		);
        ...
        $this->add_responsive_control(
			'feature_box_padding',
			[
				'label' => esc_html__( 'Padding to Box', 'mellow' ),
		...
		$this->add_control(
			'icon_properties',
			[
				'label' 	=> esc_html__( 'Style to Icon / Image', 'mellow' ),
		...
		$this->add_control(
			'feature_icon_style',
			[
				'label' => esc_html__( 'Background Style', 'mellow' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'dtr-feature--style-circle',
				'label_block' => true,
				'options' => [
					'dtr-feature--style-default'	=> esc_html__( 'None', 'mellow' ),
                    'dtr-feature--style-rounded' 	=> esc_html__( 'Rounded Background', 'mellow' ),
					'dtr-feature--style-circle' 	=> esc_html__( 'Circle Background', 'mellow' ),
					'dtr-feature--style-square'		=> esc_html__( 'Square Background', 'mellow' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Size', 'mellow' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'dtr-feature--size-small',
				'label_block' => true,
				'options' => [
                    ''	                        => esc_html__( 'None - For Only Icon Style', 'mellow' ),
					'dtr-feature--size-small'	=> esc_html__( 'Small', 'mellow' ),
                    'dtr-feature--size-medium' 	=> esc_html__( 'Medium', 'mellow' ),
					'dtr-feature--size-large' 	=> esc_html__( 'Large', 'mellow' ),
				],
			]
		);
		...
		$this->add_control(
			'feature_align_style',
			[
				'label' => esc_html__( 'Icon / Image Align', 'mellow' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'dtr-feature--icon-align-left',
				'label_block' => true,
				'options' => [
					'dtr-feature--icon-align-left'		=> esc_html__( 'Left', 'mellow' ),
					'dtr-feature--icon-align-right' 	=> esc_html__( 'Right', 'mellow' ),
					'dtr-feature--icon-align-top'	    => esc_html__( 'Top', 'mellow' ),
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'label_block' => true,
				'options' => [
					'dtr-feature--text-left'	=> esc_html__( 'Left', 'mellow' ),
					'dtr-feature--text-right' 	=> esc_html__( 'Right', 'mellow' ),
					'dtr-feature--text-center'	=> esc_html__( 'Center', 'mellow' ),
				],
				'condition' => [
		...
		$this->add_control(
			'feature_vert_align',
			[
				'label' => esc_html__( 'Icon Vertical Align', 'mellow' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'dtr-feature--icon-vert-align-top',
				'label_block' => true,
				'options' => [
					'dtr-feature--icon-vert-align-top'		=> esc_html__( 'Top', 'mellow' ),
					'dtr-feature--icon-vert-align-center'	=> esc_html__( 'Middle', 'mellow' ),
				],
				'condition' => [
		...
		$this->add_control(
			'icon_m_top',
			[
				'label' => esc_html__( 'Margin Top to Icon', 'mellow' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 200,
		...
		$this->add_control(
			'icon_m_left',
			[
				'label' => esc_html__( 'Margin Left to Icon', 'mellow' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 200,
        ...
        $this->add_control(
			'heading_m_top',
			[
				'label' => esc_html__( 'Margin Top to Heading', 'mellow' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 200,
        ...
        $this->add_control(
			'text_properties',
			[
				'label' 	=> esc_html__( 'Feature Text', 'mellow' ),
				'type' 		=> Controls_Manager::HEADING,
                'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'text_m_top',
			[
				'label' => esc_html__( 'Margin Top', 'mellow' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 200,
        ...
        $this->add_control(
			'subtext_properties',
			[
				'label' 	=> esc_html__( 'Subtext', 'mellow' ),
				'type' 		=> Controls_Manager::HEADING,
                'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::TEXTAREA,
				'default' 		=> '',
				'placeholder' 	=> esc_html__( 'Sub Text', 'mellow' ),
				'label_block'	=> true,
				'show_label'	=> true,
			]
		);
        ...
        $this->add_control(
			'link_text',
			[
				'label' => __( 'Link Text', 'mellow' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Learn More', 'mellow' ),
				'separator' => '',
				'placeholder' => __( 'Learn More', 'mellow' ),
			]
		);
		...
		$this->add_control(
			'box_hover_bg_color',
			[
				'label' => __( 'On Hover - Background Color', 'mellow' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'feature_wrap_style'	=> [ 'dtr-feature--boxed' ],
		...
		$this->add_control(
			'icon_hover_color',
			[
				'label' => __( 'On Box Hover - Color', 'mellow' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'feature_wrap_style'	=> [ 'dtr-feature--boxed' ],
		...
		$this->add_control(
			'icon_hover_bg_color',
			[
				'label' => __( 'On Box Hover - Background Color', 'mellow' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'feature_wrap_style'	=> [ 'dtr-feature--boxed' ],
		...
		$this->add_control(
			'heading_hover_color',
			[
				'label' 	=> esc_html__( 'Color - On Box Hover', 'mellow' ),
				'type' 		=> Controls_Manager::COLOR,
				'default' 	=> '',
				'condition' => [
					'feature_wrap_style'	=> [ 'dtr-feature--boxed' ],
