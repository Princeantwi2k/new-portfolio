 ...
 * Widget
 */
class Mellow_Animated_Heading extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Animated Heading', 'mellow' );
	}
	...
	public function __construct( $data = [], $args = null ) {
		parent::__construct( $data, $args );
	  	wp_register_script( 'animated-headline', MELLOW_ELEMENTOR_ADDONS_URL . 'assets/js/animated-headline.js', [ 'elementor-frontend' ], '1.0.0', true );
		wp_register_style( 'animated-headline', MELLOW_ELEMENTOR_ADDONS_URL . 'assets/css/animated-headline.css' );
    }
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label'	=> esc_html__( 'Animated Heading', 'mellow' ),
			]
		);
		...
		$this->add_control(
			'animation_style',
			[
				'label' 	=> esc_html__( 'Animation Style', 'mellow' ),
				'type' 		=> Controls_Manager::SELECT,
				'options'	=> [
					'slide' 	=> esc_html__( 'Slide', 'mellow' ),
					'push'		=> esc_html__( 'Push', 'mellow' ),
					'rotate-1'	=> esc_html__( 'Rotate', 'mellow' ),
					'zoom'		=> esc_html__( 'Zoom', 'mellow' ),
				],
				'default'	=> 'slide',
			]
		);
		...
		$this->add_control(
			'info_one',
			[
				'label' 	=> esc_html__( 'Leave Before / After Animating Text field blank if need to rotate complete sentences', 'mellow' ),
		...
		$this->add_control(
			'heading_before',
			[
				'label' 		=> esc_html__( 'Before Animating Text', 'mellow' ),
				'type' 			=> Controls_Manager::TEXTAREA,
				'default' 		=> esc_html__( 'Experience The', 'mellow' ),
				'placeholder' 	=> esc_html__( 'Experience The', 'mellow' ),
				'label_block'	=> true,
				'show_label'	=> true,
				'separator'		=> 'before',
			]
		...
		$this->add_control(
			'heading_after',
			[
				'label' 		=> esc_html__( 'After Animating Text', 'mellow' ),
				'type' 			=> Controls_Manager::TEXTAREA,
				'default' 		=> '',
				'placeholder' 	=> '',
				'label_block'	=> true,
		...
		$this->add_control(
			'heading_size',
			[
				'label' 	=> esc_html__( 'HTML Tag', 'mellow' ),
				'type' 		=> Controls_Manager::SELECT,
				'separator'		=> 'before',
				'options'	=> [
					'h1' 	=> 'H1',
		...
		$this->add_control(
			'text_l1',
			[
				'label' 		=> esc_html__( 'First Rotating Word', 'mellow' ),
				'type' 			=> Controls_Manager::TEXT,
				'default' 		=> esc_html__( 'Good', 'mellow' ),
				'placeholder' 	=> esc_html__( 'Good', 'mellow' ),
				'label_block'	=> true,
				'show_label'	=> true,
				'separator' 	=> 'before',
			]
		...
		$repeater->add_control(
			...
			[
				'label' 		=> '',
				'type' 			=> Controls_Manager::TEXT,
				'default' 		=> esc_html__( 'Better', 'mellow' ),
				'separator'		=> 'before',
				'placeholder'	=> esc_html__( 'Better', 'mellow' ),
				'label_block' 	=> true,
			]
		);
		...
		$this->add_control(
			'animating_items',
			[
				'label' => __( 'Other Words to Rotate', 'mellow' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'animating_items_text'	=> __( 'Better', 'mellow' ),
					],
					[
						'animating_items_text'	=> __( 'Best', 'mellow' ),
					],
				],
		...
		$this->add_control(
			'animated_text_color',
			[
				'label' 	=> esc_html__( 'Animating Words Color', 'mellow' ),
				'default' 	=> '',
				'type' 		=> Controls_Manager::COLOR,
				'selectors'	=> [
