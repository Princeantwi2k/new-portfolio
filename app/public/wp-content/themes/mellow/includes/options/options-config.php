...
$args = array(
	...
	'menu_title'                => esc_html__( 'Theme Options', 'mellow' ),
	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Theme Options', 'mellow' ),
...
$args['admin_bar_links'][] = array(
	...
	'title' => __( 'Theme Documentation', 'mellow' ),
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Header', 'mellow' ),
		'id'    => 'section-header',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Page Title Section', 'mellow' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Footer', 'mellow' ),
		'id'    => 'section-footer',
...
function mellow_enqueue_redux_custom_css() {
    wp_enqueue_style(
...
add_action('admin_enqueue_scripts', 'mellow_enqueue_redux_custom_css', 100);