 ...
 */
if ( ! function_exists( 'mellow_enable_elementor_for_cpt' ) ) {
    function mellow_enable_elementor_for_cpt() {
        if ( true == mellow_get_theme_option( 'mellow_set_elementor_settings', true ) ) {
...
add_action('init', 'mellow_enable_elementor_for_cpt');

// Disable Elementor default colors
function mellow_disable_elementor_default_colors() {
...
add_action('admin_init', 'mellow_disable_elementor_default_colors');


// Disable Elementor default typography
function mellow_disable_elementor_default_typography() {
    // Get the current setting for disabling default typography schemes
...
add_action('admin_init', 'mellow_disable_elementor_default_typography');