...
<div id="dtr-header-global" class="clearfix">
    <div class="dtr-header-global-content">
        ...
        <?php } ?>
        <?php if (is_active_sidebar('widget-header-one') && true == mellow_get_theme_option('mellow_header_widget_area_one_enable', true) || true == mellow_get_theme_option('mellow_header_search_enable', false) || true == mellow_get_theme_option('mellow_header_button_enable', false)) { ?>
