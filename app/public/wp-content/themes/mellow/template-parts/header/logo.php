...
if( get_theme_mod( 'mellow_logo_type', 'mellow_text_logo' ) == 'mellow_img_logo' && $dtr_custom_logo_image != '' ) { ?>
<a class="dtr-logo logo-default" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php bloginfo('title'); ?>"><img src="<?php echo esc_url( $dtr_custom_logo_image[0] ) ?>" alt="<?php esc_attr( bloginfo( 'title' ) ); ?>" width="<?php echo esc_attr( get_theme_mod( 'mellow_logo_width', '' ) ) ?>" height="<?php echo esc_attr( get_theme_mod( 'mellow_logo_height', '' ) ) ?>"><?php if ( !empty( $dtr_logo_sub_text ) ) { ?><span class="dtr-logo-subtext"><?php echo esc_html($dtr_logo_sub_text); ?></span><?php } ?></a>
