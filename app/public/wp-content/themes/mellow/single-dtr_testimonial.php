...
?>
<?php if ( true == mellow_get_theme_option( 'mellow_enable_testimonial_pagetitle_section', true ) ) { ?>
<div class="dtr-page-title--section <?php echo esc_attr( $title_align ); ?>">
    ...
    <div class="container">
        <div class="dtr-page-title__content">
            <?php if ( true == mellow_get_theme_option( 'mellow_enable_testimonial_page_title', true ) ) {
            the_title( '<h1 class="dtr-page-title">', '</h1>' );
        } ?>
        </div>
        <?php if ( true == mellow_get_theme_option( 'mellow_enable_testimonial_breadcrumb', true ) ) { ?>
...
<div id="dtr-main-wrapper" class="container clearfix dtr-fullwidth">
    <main id="dtr-primary-section" class="dtr-content-area">
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <?php if ( true == mellow_get_theme_option( 'mellow_testimonial_single_image', true ) ) { ?>
